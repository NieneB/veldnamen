  ...
  //-------------------
    ...
    transect.selectAll(".bodem")
      ...
      .on("mouseover", function(d){
        ...
        var categories = {
            ...
            var nr1;
            var nr2;
            if(d[0].category1 != null){
              nr1 = d[0].category1.toLowerCase()
            };
            if(d[0].category2 != null){
              nr2 = d[0].category2.toLowerCase()
            };
        d3.text("text/" + nr1 + ".txt", function(text){
          d3.text("text/" + nr2 +".txt", function(text2){
   ...
   transect.selectAll("image")
      ...
      .attr("xlink:href",  function(x){ 
        var picture;
        if(x[0].category1 != null){
           picture = x[0].category1.toLowerCase()
        }
